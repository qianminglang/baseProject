...
import com.clear.constant.HttpStatus;
import com.clear.exception.BizCode;
...
public class R<T> implements Serializable {
     ...
     * 成功
     */
    public static final int SUCCESS = BizCode.SUCCESS;

    /**
     * 失败
     */
    public static final int FAIL = BizCode.FAIL;
